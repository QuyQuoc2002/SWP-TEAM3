 ...
 * @author DELL
 */
@WebServlet(name = "GetCodeConfirmcController", urlPatterns = {"/get-code-confirm"})
public class GetCodeConfirmController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Account account = new AccountService().authenticate(username, apartmentId);
            if (account != null) {
                try {
                ...
                response.sendRedirect("forgot-password?apartmentId=" + apartmentId);
            }
        }
    }
