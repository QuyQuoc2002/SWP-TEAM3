                                ...
                                <div class="row panel-form mx-0">
                                    ...
                                    <div class="col-6 form-group mb-3">
                                        <fieldset>
                                            ...
                                            <input id="currentDate" type="text" class="form-control" name="apartmentHostPhone" value="${Calendars.formatTime('dd/MM/yyy HH:mm:ss', requestScope.apartment.apartmentCreateTime)}" readonly="">
                                        </fieldset>
                                    </div>
