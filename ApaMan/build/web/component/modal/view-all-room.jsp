...
<div class="modal fade" id="view-all-room" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content bg-secondary-cus">
            <div class="rounded my-4 mx-3">
                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.allRoom}" var="room" varStatus="i">
                            <tr>
                                <td>${i.count}</td>
